...
public sealed partial class XoRecordManifestSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<XoRecordManifestComponent, GeneralRecordCreatedEvent>(OnRecordCreated);
        SubscribeLocalEvent<XoRecordManifestComponent, RecordModifiedEvent>(OnRecordModified);
        SubscribeLocalEvent<XoRecordManifestComponent, RecordRemovedEvent>(OnRecordRemoved);
    }
